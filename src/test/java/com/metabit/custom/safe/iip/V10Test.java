...
import static com.metabit.custom.safe.iip.InterleavedIntegrityPadding_V1_0.NONCE_SIZE;
...
class V10Test
{
    ...
    void calculateNumberOfBytesOverall()
        ...
        for (int i = 1; i < 8192; i++) // 8192 is just to limit the runtime.
            {
            result = Math.toIntExact(InterleavedIntegrityPadding_V1_0.calculateNumberOfBytesOverall(i, CIPHER_BLOCK_SIZE));
    ...
    void performPaddingWithAllocationSimpleTest() throws BadPaddingException
        {
        InterleavedIntegrityPadding_V1_0 instance = new InterleavedIntegrityPadding_V1_0(CIPHER_BLOCK_SIZE);
